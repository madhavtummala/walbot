...
class DualMomentumConfig:
    ...
    selection_horizon_nano_minutes: int = field(default=60, metadata={"legacy_key": "selection_horizon_nano"})
    selection_horizon_micro_minutes: int = field(default=240, metadata={"legacy_key": "selection_horizon_micro"})
    selection_horizon_meso_minutes: int = field(default=1200, metadata={"legacy_key": "selection_horizon_meso"})
    selection_horizon_macro_minutes: int = field(default=4800, metadata={"legacy_key": "selection_horizon_macro"})
    w_nano: float = 0.10
    w_micro: float = 0.20
    w_meso: float = 0.35
    w_macro: float = 0.35
